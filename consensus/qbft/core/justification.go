...
// prepared block.
func hasQuorumOfRoundChangeMessagesForNil(roundChangeMessages []*message.SignedRoundChangePayload, quorumSize int) error {
	nilCount := 0
...
func hasQuorumOfRoundChangeMessagesForPreparedRoundAndBlock(roundChangeMessages []*message.SignedRoundChangePayload, preparedRound *big.Int, preparedBlock istanbul.Proposal, quorumSize int) error {
...
func hasMatchingRoundChangeAndPrepares(
	roundChange *message.RoundChange, prepareMessages []*message.SignedPreparePayload, quorumSize int) error {
