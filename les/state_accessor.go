...
func (leth *LightEthereum) stateAtTransaction(ctx context.Context, block *types.Block, txIndex int, reexec uint64) (core.Message, vm.BlockContext, *state.StateDB, mps.PrivateStateRepository, func(), error) {
	...
	if txIndex == 0 && len(block.Transactions()) == 0 {
		return nil, vm.BlockContext{}, statedb, nil, func() {}, nil
	}
	...
	for idx, tx := range block.Transactions() {
		...
		if idx == txIndex {
			return msg, context, statedb, nil, func() {}, nil
		}
