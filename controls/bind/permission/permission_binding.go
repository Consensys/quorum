...
// AddInitAccount is a paid mutator transaction binding the contract method 0x568514be.
//
// Solidity: function addInitAccount(_addr address) returns()
func (_Permissions *PermissionsTransactor) AddInitAccount(opts *bind.TransactOpts, _addr common.Address) (*types.Transaction, error) {
	return _Permissions.contract.Transact(opts, "addInitAccount", _addr)
}

// AddInitAccount is a paid mutator transaction binding the contract method 0x568514be.
//
// Solidity: function addInitAccount(_addr address) returns()
func (_Permissions *PermissionsSession) AddInitAccount(_addr common.Address) (*types.Transaction, error) {
	return _Permissions.Contract.AddInitAccount(&_Permissions.TransactOpts, _addr)
}

// AddInitAccount is a paid mutator transaction binding the contract method 0x568514be.
//
// Solidity: function addInitAccount(_addr address) returns()
func (_Permissions *PermissionsTransactorSession) AddInitAccount(_addr common.Address) (*types.Transaction, error) {
	return _Permissions.Contract.AddInitAccount(&_Permissions.TransactOpts, _addr)
}
