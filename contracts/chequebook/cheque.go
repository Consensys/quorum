...
// issuing, receiving, verifying cheques in xlg; (auto)cashing cheques in xlg
// as well as (auto)depositing xlg to the chequebook contract.
package chequebook
...
// * depositing xlg to the chequebook
// * watching incoming xlg
