...
// GetAmendmentCount is a free data retrieval call binding the contract method 0xb577e454.
//
// Solidity: function getAmendmentCount(uint256 _documentId) view returns(uint256 _totalAmendment, uint256 _numOfRootAmendment)
func (_RouterService *RouterServiceCaller) GetAmendmentCount(opts *bind.CallOpts, _documentId *big.Int) (struct {
	TotalAmendment     *big.Int
	NumOfRootAmendment *big.Int
}, error) {
	var out []interface{}
	err := _RouterService.contract.Call(opts, &out, "getAmendmentCount", _documentId)
	...
	outstruct.TotalAmendment = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
	outstruct.NumOfRootAmendment = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
...
//
// Solidity: function getAmendmentCount(uint256 _documentId) view returns(uint256 _totalAmendment, uint256 _numOfRootAmendment)
func (_RouterService *RouterServiceSession) GetAmendmentCount(_documentId *big.Int) (struct {
	TotalAmendment     *big.Int
	NumOfRootAmendment *big.Int
}, error) {
	return _RouterService.Contract.GetAmendmentCount(&_RouterService.CallOpts, _documentId)
}

// GetAmendmentCount is a free data retrieval call binding the contract method 0xb577e454.
//
// Solidity: function getAmendmentCount(uint256 _documentId) view returns(uint256 _totalAmendment, uint256 _numOfRootAmendment)
func (_RouterService *RouterServiceCallerSession) GetAmendmentCount(_documentId *big.Int) (struct {
	TotalAmendment     *big.Int
	NumOfRootAmendment *big.Int
}, error) {
	return _RouterService.Contract.GetAmendmentCount(&_RouterService.CallOpts, _documentId)
...
//
// Solidity: function getAmendmentRequest(uint256 _documentId, uint256 _requestId) view returns((uint256,address,bytes32[],(uint256,uint256,(bytes32,uint256,bytes32,uint256,bytes32[],string,bytes,bytes)),(string,string,string,bytes,bytes,bytes),bool))
...
// GetInvolvedParties is a free data retrieval call binding the contract method 0xeb710fb2.
//
// Solidity: function getInvolvedParties(uint256 _documentId) view returns(string[])
func (_RouterService *RouterServiceCaller) GetInvolvedParties(opts *bind.CallOpts, _documentId *big.Int) ([]string, error) {
	var out []interface{}
	err := _RouterService.contract.Call(opts, &out, "getInvolvedParties", _documentId)
...
//
// Solidity: function getInvolvedParties(uint256 _documentId) view returns(string[])
func (_RouterService *RouterServiceSession) GetInvolvedParties(_documentId *big.Int) ([]string, error) {
	return _RouterService.Contract.GetInvolvedParties(&_RouterService.CallOpts, _documentId)
}

// GetInvolvedParties is a free data retrieval call binding the contract method 0xeb710fb2.
//
// Solidity: function getInvolvedParties(uint256 _documentId) view returns(string[])
func (_RouterService *RouterServiceCallerSession) GetInvolvedParties(_documentId *big.Int) ([]string, error) {
	return _RouterService.Contract.GetInvolvedParties(&_RouterService.CallOpts, _documentId)
}
