...
type PermissionContractService interface {
	RemoveRole(_roleId string, _orgId string) (*Transaction, error)
	AddNewRole(_roleId string, _orgId string, _access *big.Int, _voter bool, _admin bool) (*Transaction, error)
	...
	AssignAccountRole(_account common.Address, _orgId string, _roleId string) (*Transaction, error)
	UpdateAccountStatus(_orgId string, _account common.Address, _action *big.Int) (*Transaction, error)
	ApproveBlacklistedNodeRecovery(_orgId string, _enodeId string, _ip string, _port uint16, _raftport uint16, _url string) (*Transaction, error)
	StartBlacklistedNodeRecovery(_orgId string, _enodeId string, _ip string, _port uint16, _raftport uint16, _url string) (*Transaction, error)
	StartBlacklistedAccountRecovery(_orgId string, _account common.Address) (*Transaction, error)
	ApproveBlacklistedAccountRecovery(_orgId string, _account common.Address) (*Transaction, error)
	GetPendingOp(_orgId string) (string, string, common.Address, *big.Int, error)
	ApproveAdminRole(_orgId string, _account common.Address) (*Transaction, error)
	AssignAdminRole(_orgId string, _account common.Address, _roleId string) (*Transaction, error)
	AddNode(_orgId string, _enodeId string, _ip string, _port uint16, _raftport uint16, _url string) (*Transaction, error)
	UpdateNodeStatus(_orgId string, _enodeId string, _ip string, _port uint16, _raftport uint16, _url string, _action *big.Int) (*Transaction, error)
	ApproveOrgStatus(_orgId string, _action *big.Int) (*Transaction, error)
	UpdateOrgStatus(_orgId string, _action *big.Int) (*Transaction, error)
	ApproveOrg(_orgId string, _enodeId string, _ip string, _port uint16, _raftport uint16, _account common.Address, _url string) (*Transaction, error)
	AddSubOrg(_pOrgId string, _orgId string, _enodeId string, _ip string, _port uint16, _raftport uint16, _url string) (*Transaction, error)
	AddOrg(_orgId string, _enodeId string, _ip string, _port uint16, _raftport uint16, _account common.Address, _url string) (*Transaction, error)
	...
	UpdateNetworkBootStatus() (*Transaction, error)
	AddAdminAccount(_acct common.Address) (*Transaction, error)
	AddAdminNode(_enodeId string, _ip string, _port uint16, _raftport uint16) (*Transaction, error)
	SetPolicy(_nwAdminOrg string, _nwAdminRole string, _oAdminRole string) (*Transaction, error)
	Init(_breadth *big.Int, _depth *big.Int) (*Transaction, error)
