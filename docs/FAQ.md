...
??? question "How does Quorum achieve Transaction Privacy?"
    ...
    Please see the [Transaction Processing](https://github.com/Krish1979/quorum/blob/master/docs/Transaction%20Processing/Transaction%20Processing.md) page for more info.
...
??? question "How does Quorum achieve consensus on Private Transactions?"
    ...
    Please see the [[Quorum Consensus|Quorum Consensus]] and [Transaction Processing](https://github.com/Krish1979/quorum/blob/master/docs/Transaction%20Processing/Transaction%20Processing.md) pages for more info.
