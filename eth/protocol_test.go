...
func TestForkIDSplit(t *testing.T) {
	var (
		...
		chainNoFork, _  = core.NewBlockChain(dbNoFork, nil, configNoFork, engine, vm.Config{}, nil, nil, &core.DefaultPrivateStateMetadataResolver{})
		chainProFork, _ = core.NewBlockChain(dbProFork, nil, configProFork, engine, vm.Config{}, nil, nil, &core.DefaultPrivateStateMetadataResolver{})
