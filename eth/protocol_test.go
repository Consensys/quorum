...
func TestForkIDSplit(t *testing.T) {
	var (
		...
		chainNoFork, _  = core.NewBlockChain(dbNoFork, nil, nil, configNoFork, engine, vm.Config{}, nil, nil)
		chainProFork, _ = core.NewBlockChain(dbProFork, nil, nil, configProFork, engine, vm.Config{}, nil, nil)
