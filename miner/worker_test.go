...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db ethdb.Database, n int) *testWorkerBackend {
	...
	chain, _ := core.NewBlockChain(db, &core.CacheConfig{TrieDirtyDisabled: true}, &core.CacheConfig{TrieDirtyDisabled: true}, gspec.Config, engine, vm.Config{}, nil, nil)
...
func testGenerateBlockAndImport(t *testing.T, isClique bool) {
	...
	chain, _ := core.NewBlockChain(db2, nil, nil, b.chain.Config(), engine, vm.Config{}, nil, nil)
	defer chain.Stop()
