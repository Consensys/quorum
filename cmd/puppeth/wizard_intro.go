...
func makeWizard(network string, consensusType string, blocksTime uint64, sealAccounts string, preFundedAccounts string, networkID uint64, nonInteract bool) *wizard {
	return &wizard{
		network: network,
		conf: config{
