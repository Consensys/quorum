...
func TestUnlockFlagMultiIndex(t *testing.T) {
	defer SetResetPrivateConfig("ignore")()
	geth := runMinimalGethWithRaftConsensus(t, "--port", "0", "--ipcdisable", "--datadir", tmpDatadirWithKeystore(t),
		"--unlock", "f466859ead1932d743d622cb74fc058882e8648a", "--unlock", "f466859ead1932d743d622cb74fc058882e8648a", "--unlock", "0,2", "js", "testdata/empty.js")
	geth.Expect(`
...
func TestUnlockFlagAmbiguous(t *testing.T) {
	...
	geth := runMinimalGethWithRaftConsensus(t, "--datadir", tmpDatadirWithKeystore(t), "--port", "0", "--ipcdisable", "--datadir", tmpDatadirWithKeystore(t),
