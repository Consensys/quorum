...
func TestConsoleWelcome(t *testing.T) {
	...
	geth.SetTemplateFunc("gethver", func() string { return params.params.VersionWithCommit("", "") })
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint, apis string) {
	...
	attach.SetTemplateFunc("gethver", func() string { return params.params.VersionWithCommit("", "") })
