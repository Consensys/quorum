...
using r1cs_gg_ppzksnark_constraint_system = r1cs_constraint_system<Fr<ppT> >;

template<typename ppT>
using r1cs_gg_ppzksnark_primary_input = r1cs_primary_input<Fr<ppT> >;

template<typename ppT>
using r1cs_gg_ppzksnark_auxiliary_input = r1cs_auxiliary_input<Fr<ppT> >;
