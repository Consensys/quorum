...
type ContractIndexImpl struct {
	db ethdb.Database
}

func NewContractIndex(db ethdb.Database) *ContractIndexImpl {
	return &ContractIndexImpl{
		db: db,
	}
}
...
func (ci ContractIndexImpl) WriteIndex(contractAddress common.Address, indexItem *ContractIndexItem) error {
...
func (ci ContractIndexImpl) ReadIndex(contractAddress common.Address) (*ContractIndexItem, error) {
